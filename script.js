...
document.querySelector("[data-AC]").addEventListener("click", function () {
  // Prompt the user to confirm if they want to clear the calculator
  if (confirm("Are you sure you want to clear the calculator?")) {
    // If the user clicks "OK", clear the calculator
    press("clear");
  } else {
...
// Add an event listener to the RUFUS button
document.querySelector("[data-operation][id='name']").addEventListener("click", function () {
  // Alert the message
  alert("Hello Welcome to Rufus Calculator.This calculator will help you solve mathematical isues in a flawless way your all set to ggo Innit!.");
});